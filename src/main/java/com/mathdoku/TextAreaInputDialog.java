 ...
 * 
 * @link{https://stackoverflow.com/questions/53490172/javafx-creating-a-text-input-box}
 */
public class TextAreaInputDialog extends Dialog<String> {
    ...
    public TextAreaInputDialog(@NamedArg("defaultValue") String defaultValue) {
        ...
        dialogPane.getStylesheets().add(getClass().getResource("CSS/LoadFromInputDesign.css").toExternalForm());
